        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="TableUser" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Pet Tables</a>
  ...
  <div class="col-sm">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text-light">With supporting text below as a natural lead-in to additional content.</p>
